...
<html >
  <head>
    <meta charset="UTF-8">
    <title>GroupFinder Timeline</title>
        ...
        <!-- Posts -->
          <div class="col-xs-12 col-sm-9">
            ...
            <div class="container" style="display: inline-block; background: lightblue;width: 400px;">
              <h4>User Groups<a href="#0">(See All)</a></h4>
            ...
            <div class="container" style="display: inline-block; background: lightblue;width: 400px;">
              <h4>User Events<a href="#0">(See All)</a></h4>
            ...
            <div class="container" style="display: inline-block; background: lightgreen;width: 400px;">
              <h4>User Businesses<a href="#0">(See All)</a></h4>
